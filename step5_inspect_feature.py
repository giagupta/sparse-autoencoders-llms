"""
Step 5: Deep-dive inspection of a single feature from the trained RA-SAE.
Shows the top activations for a specific feature to understand its "persona".
"""
...
# Configuration
FEATURE_TO_INSPECT = 111  # Change this to inspect different features
LAYER = 9
N_FEATURES = 4096
TOP_K = 64
